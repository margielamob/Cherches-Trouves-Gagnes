...
describe("MainPageComponent", () => {
  ...
  beforeEach(async () => {
    spyMainPageService = jasmine.createSpyObj("GamePageService", [
      "setGameMode",
    ]);
    spyGameInfosHandlerService = jasmine.createSpyObj(
      "GameInformationHandlerService",
      ["setGameMode", "getGameName", "getGameMode"]
    );
    spyMatDialog = jasmine.createSpyObj<MatDialog>("MatDialog", [
      "open",
      "closeAll",
    ]);
    spyCommunicationService = jasmine.createSpyObj("CommunicationService", [
      "getAllGameInfos",
      "getGamesInfoByPage",
    ]);
  ...
  it("should set GameMode to Classic when Classic button is clicked", () => {
    ...
    expect(spyMainPageService.setGameMode).toHaveBeenCalledWith(
      GameMode.Classic
    );
  });
  ...
  it("should redirect to error page if there is an error", () => {
    spyCommunicationService.getGamesInfoByPage.and.returnValue(
